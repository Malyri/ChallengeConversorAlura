...
import com.conversor.model.Operacion;
...
public class ConversorController {
	...
	public void UtilizarConversorMoneda() {

		try {

			// Setting URL
			String STR_URL = "https://api.exchangerate.host/convert?from=" + this.conversion.getConvertirDe() + "&to="
	...
	public void UtilizarConversorTemperatura() {
	...
	public String getResultado() {
		...
		if (this.id == 1) {
			...
			UtilizarConversorMoneda();

		} else {

			UtilizarConversorTemperatura();
